...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="<?php echo base_url('assets/')?>css/export.css" rel="stylesheet" type="text/css" media="all" />
    <link href="<?php echo base_url('assets/')?>css/flipclock.css" rel="stylesheet" type="text/css" media="all" />
    <link href="<?php echo base_url('assets/')?>css/circles.css" rel="stylesheet" type="text/css" media="all" />
                ...
                <nav class="gn-menu-wrapper">
                    <div class="gn-scroller scrollbar1">
                        <ul class="gn-menu agile_menu_drop">
                            <li><a href="<?php echo site_url('MyController/index')?>"> <i class="fa fa-tachometer"></i> หน้าหลัก แผนก <?php echo $this->session->userdata('department_name'); ?></a></li>
                            <li>
                            ...
                            <li><a href="<?php echo site_url('MyController/logout')?>"><i class="fa fa-map-o" aria-hidden="true"></i> Log out</a></li>
